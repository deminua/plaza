    ...
    <div class="container">
        <div class="row">
            ...
            <article class="col-sm-4">
             @if(is_object($new->avatar->first()))<a title="{{ $new->name }}" href="#"><img alt="{{ $new->name }}" src="{{ route('imagecache', ['medium', $sale->avatar->first()->filename]) }}" class="img-responsive"></a>@endif
